          ...
          <div className="space-y-6">
            ...
            {clientSecret && !clientSecret.startsWith('mock_') ? (
              ...
              <div className="space-y-4 pt-2">
                <div className="p-3 bg-muted/60 rounded-md border text-sm text-muted-foreground">
                  Demo Checkout Mode: Complete payment test without live Stripe credentials.
                </div>
                <Button className="w-full" onClick={onPaymentComplete}>
                  Confirm Test Order (${total.toFixed(2)})
                </Button>
              </div>
            ) : (
